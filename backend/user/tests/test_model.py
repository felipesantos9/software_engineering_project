...
class UserModelTest(TestCase):
    ...
    def test_superuser_creation(self):
        ...
        """
        self.user = self.user_model.create_user(
            **get_object_user(is_staff=True, is_superuser=True)
        )
    ...
    def test_email_invalid(self):
        ...
        user = self.user_model.create_user(
            **get_object_user(email='invalid_email.com')
        )
    ...
    def test_unique_email(self):
        ...
        self.user_model.create_user(
            **get_object_user(email='exemplo@exemplo.com')
        )
